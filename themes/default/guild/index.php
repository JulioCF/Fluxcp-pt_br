...
<form action="<?php echo $this->url ?>" method="get" class="search-form">
	...
	<p>
		...
		...
		<label for="guild_name">Nome:</label>
	...
	<p>
		<label for="guild_level">Level:</label>
...
<table class="horizontal-table">
	<tr>
		<th><?php echo $paginator->sortableColumn('guild.guild_id', 'ID') ?></th>
		<th colspan="2"><?php echo $paginator->sortableColumn('guildName', 'Nome') ?></th>
